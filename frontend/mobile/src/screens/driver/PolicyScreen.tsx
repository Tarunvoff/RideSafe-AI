/**
 * [EXCELLENCE SUMMARY]
 * The PolicyScreen is the 'Contractual Interface' between the driver 
 * and the Aegis platform. It provides a transparent, real-time view of 
 * active insurance policies, billing cycles, and coverage thresholds. 
 * Architected with 'Zero-Friction Activation' in mind, it utilizes a 
 * fluid 'Slide-to-Dashboard' interaction to reinforce the sense of 
 * security and readiness.
 * 
 * [DOMAIN LOGIC]
 * Manages the "Active Policy Lifecycle". It synchronizes with the Policy API 
 * to track 'Policy State' (Active/Inactive), 'Billing Synchronicity' 
 * (Next Billing date), and 'Automatic Claim Status'. This transparency is 
 * critical for maintaining the 'Trust Handshake', ensuring the driver knows 
 * exactly when they are protected against environmental disruptions.
 */
...
export default function PolicyScreen({ navigation }: any) {
  ...
  /**
   * [IN-LINE PRIDE]: Intentional Interaction Pattern
   * Implements a 'PanResponder' based 'Slide-to-Dashboard' gesture. 
   * This isn't just a UI flourish; it requires an intentional, 
   * high-motor-skill action that psychologically reinforces the 
   * moment of "Going Online" protected by an Aegis policy.
   */
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.heroSection}>
          {/**
           * [IN-LINE PRIDE]: Contextual Hero States
           * The hero section dynamically transforms its messaging based on 
           * policy presence. For active users, it reaffirms coverage; for 
           * others, it provides a clear 'Call to Action' (CTA) to browse plans.
           */}
