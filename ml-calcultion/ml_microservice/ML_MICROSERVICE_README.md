# Aegis: ML Intelligence Microservice

This repository houses the standalone **Machine Learning & Real-Time Intelligence Microservice** for the Aegis parametric insurance platform. 
