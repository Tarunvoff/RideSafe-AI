...
export default function AdminFraudReportScreen({ route, navigation }: any) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {/* Admin Nav Bar placeholder (UI only) */}
      <View style={styles.bottomNav}>
         <TouchableOpacity style={styles.navItem}>
            <Ionicons name="grid-outline" size={24} color={SLATE_500} />
            <Text style={styles.navText}>DASH</Text>
         </TouchableOpacity>
         <TouchableOpacity style={styles.navItem}>
            <Ionicons name="shield-outline" size={24} color={PRIMARY} />
            <Text style={[styles.navText, { color: PRIMARY }]}>ALERTS</Text>
         </TouchableOpacity>
         <TouchableOpacity style={styles.navItem}>
            <Ionicons name="time-outline" size={24} color={SLATE_500} />
            <Text style={styles.navText}>HISTORY</Text>
         </TouchableOpacity>
         <TouchableOpacity style={styles.navItem}>
            <Ionicons name="settings-outline" size={24} color={SLATE_500} />
