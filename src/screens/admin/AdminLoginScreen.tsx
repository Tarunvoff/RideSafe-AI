...
const styles = StyleSheet.create({
  ...
  brandTitle: { ...Theme.typography.h1, color: '#0f172a', marginBottom: 4 },
  brandSubtitle: { ...Theme.typography.caption, color: '#64748b', fontWeight: '600', letterSpacing: 1, textTransform: 'uppercase' },
  card: { padding: Theme.spacing.xl },
  loginTitle: { ...Theme.typography.h2, color: '#0f172a', marginBottom: Theme.spacing.xl, textAlign: 'center' },
  errorContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fef2f2', padding: Theme.spacing.sm, borderRadius: Theme.borderRadius.md, marginBottom: Theme.spacing.lg, borderWidth: 1, borderColor: '#fca5a5' },
