...
export default function KYCProgressOverviewScreen({ navigation }: any) {
  const steps = [
    { title: 'Personal Details', desc: 'Full name, DOB, and contact', icon: 'person' as const, status: 'current' },
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.secureNotice}>
          ...
          <Text style={styles.secureText}>
            Your data is encrypted and stored securely. We only use this information for identity verification purposes and to ensure the safety of the GigShield community.
          </Text>
        </View>
      </ScrollView>
