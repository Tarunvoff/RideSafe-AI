...
5. **Start the backend server**:
   ...
   npm run start:dev
   ```
   *✅ You should see a message saying "GigShield NestJS API running on http://0.0.0.0:3001/api". Keep this terminal open!*
...
2. **Open a second terminal** and navigate to the main project root folder:
   ```bash
   # Make sure you are in the root directory, NOT the backend folder
   ```

3. **Set up your environment variables**:
   Create a file exactly named `.env` in the root folder, and paste your IP inside like this:
   ```env
